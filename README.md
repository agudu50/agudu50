  ...
  <table width="100%">
    <tr>
      <td width="25%" valign="top">
        ...
        <img src="https://skillicons.dev/icons?i=html,css,javascript,react,vite,sass,materialui,redux,threejs,jquery,bootstrap,tailwind,andriodstudio,expogo&perline=3"/>
      </td>
      <td width="25%" valign="top">
